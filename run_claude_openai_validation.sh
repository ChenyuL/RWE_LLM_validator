...
# Script to run the Claude-OpenAI validation process for Li-Paper
...
echo "Processing papers from fixed_sampled_papers.json using Claude as extractor and OpenAI as validator"
