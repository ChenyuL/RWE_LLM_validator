...
report_files = [f for f in files if ('openai_claude_report' in f or 'claude_openai_report' in f) and f.endswith('.json') and '_Li-Paper' in f]
...
with open('li_paper_analysis_summary.md', 'w') as f:
    ...
    f.write("1. `agreement_by_config.png`: Bar chart showing mean agreement rates by configuration\n")
    f.write("2. `agreement_distribution.png`: Violin plot showing the distribution of agreement rates\n")
    f.write("3. `agreement_by_item.png`: Bar chart showing agreement rates by checklist item\n")
    f.write("4. `model_output_agreement_by_paper.png`: Bar chart showing model output agreement by paper\n")
    f.write("5. `model_output_agreement_by_item.png`: Bar chart showing model output agreement by checklist item\n")
    f.write("6. `correlation_plots.png`: Scatter plots showing correlations between validator agreement and model output agreement\n")

print("Generated li_paper_analysis_summary.md")
