...
# run_li_paper_validation_with_new_prompts.sh
# Script to run the Li-Paper validation and analysis process with the newly generated prompts
...
# Use the newly generated prompts file
PROMPT_FILE="/Users/chenyuli/LLMEvaluation/RWE_LLM_validator/output/prompts/20250322_144915_direct_reasoner_Li-Paper_prompts.json"
echo "Using prompts file: $PROMPT_FILE"
