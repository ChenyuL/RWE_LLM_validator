...
# run_analysis_complete.sh
# A script to run analysis on any reports directory using the complete analysis script
...
python run_li_paper_analysis_complete.py --reports_dir "$REPORTS_DIR" --output_dir "$OUTPUT_DIR"

echo "Analysis completed!"
echo "Visualizations and analysis files have been saved to $OUTPUT_DIR"
echo "Additionally, correlation_plots.png and model_answers_comparison.csv have been saved to the root directory for easy access."
